...
describe('Server', () => {
  ...
  describe('POST /pizzas', () => {
    ...
    it('should receive and store data', (done) => {
      ...
      this.request.post('/pizzas', { form: payload }, (error, response) => {
        ...
        var pizzasCount = Object.keys(app.locals.pizzas).length;

        assert.equal(pizzasCount, 1, `Expected 1 pizzas, found ${pizzasCount}`);
  ...
  describe('GET /pizzas/:id', () => {
    ...
    it('should return a page that has the pizzas toppings', (done) => {
      var pizza = app.locals.pizzas.testPizza;
